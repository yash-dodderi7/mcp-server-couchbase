...
mv /tmp/dp-firewall.service /lib/systemd/system/dp-firewall.service
mv /tmp/iptables-firewall.sh /home/ubuntu
chmod +x /home/ubuntu/iptables-firewall.sh
chown root:root /home/ubuntu/iptables-firewall.sh
